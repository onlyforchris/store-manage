package com.onlyforchris.store.core.qrcode;

import cn.binarywang.wx.miniapp.api.WxMaService;
import com.onlyforchris.store.core.storage.StorageService;
...
public class QCodeService {
    ...
    public String createGrouponShareImage(String goodName, String goodPicUrl, Groupon groupon) {
        try {
            ...
            //存储分享图
            DbStorage storageInfo = storageService.store(inputStream2, imageData.length, "image/jpeg",
    ...
    public String createGoodShareImage(String goodId, String goodPicUrl, String goodName) {
        ...
        try {
            ...
            ByteArrayInputStream inputStream2 = new ByteArrayInputStream(imageData);
            //存储分享图
            DbStorage Storage = storageService.store(inputStream2, imageData.length, "image/jpeg",
                    getKeyName(goodId));
