package com.onlyforchris.store.core.express;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.onlyforchris.store.core.express.config.ExpressProperties;
import com.onlyforchris.store.core.model.express.ExpressInfo;
import com.onlyforchris.store.core.utils.HttpUtil;
 ...
 * 物流查询服务
 * <p>
 * 快递鸟即时查询API <a href="http://www.kdniao.com/api-track"/>
 *
 * @author: Chris
...
public class ExpressService {
     ...
     * 快递鸟即时查询API
     */
    private final String REQ_URL = "http://api.kdniao.com/Ebusiness/EbusinessOrderHandle.aspx";
