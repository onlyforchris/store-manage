...
import com.onlyforchris.store.core.storage.LocalStorage;
...
public class LocalStorageTest {
    ...
    public void test() throws IOException {
        ...
        localStorage.store(Files.newInputStream(Paths.get(test)), testFile.length(), "image/png", "demo.png");
        Resource resource = localStorage.loadAsResource("demo.png");
        String url = localStorage.generateUrl("demo.png");
