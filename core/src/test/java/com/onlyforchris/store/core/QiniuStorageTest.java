...
import com.onlyforchris.store.core.storage.QiniuStorage;
...
public class QiniuStorageTest {
    ...
    public void test() throws IOException {
        ...
        qiniuStorage.store(Files.newInputStream(Paths.get(test)), testFile.length(), "image/png", "demo.png");
        Resource resource = qiniuStorage.loadAsResource("demo.png");
        String url = qiniuStorage.generateUrl("demo.png");
