...
public class WxStorageController {
    ...
    public Object upload(@RequestParam("file") MultipartFile file) throws IOException {
        ...
        DbStorage litemallStorage = storageService.store(file.getInputStream(), file.getSize(), file.getContentType(), originalFilename);
        return ResponseUtil.success(litemallStorage);
    }
    ...
    public ResponseEntity<Resource> fetch(@PathVariable String key) {
        DbStorage litemallStorage = dbStorageService.findByKey(key);
