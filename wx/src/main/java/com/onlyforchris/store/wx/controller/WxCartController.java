...
import static com.onlyforchris.store.wx.util.WxResponseCode.GOODS_NO_STOCK;
import static com.onlyforchris.store.wx.util.WxResponseCode.GOODS_UNSHELVE;
...
public class WxCartController {
    ...
    public Object add(@LoginUser Integer userId, @RequestBody Cart cart) {
        ...
        if (goods == null || !goods.getIsOnSale()) {
            return ResponseUtil.failed(GOODS_UNSHELVE, "商品已下架");
        }
        ...
        if (existCart == null) {
            ...
            if (product == null || number > product.getNumber()) {
                return ResponseUtil.failed(GOODS_NO_STOCK, "库存不足");
            }
    ...
    public Object fastadd(@LoginUser Integer userId, @RequestBody Cart cart) {
        ...
        return ResponseUtil.success(existCart != null ? existCart.getId() : cart.getId());
    }
    ...
    public Object update(@LoginUser Integer userId, @RequestBody Cart cart) {
        ...
        if (product == null || product.getNumber() < number) {
            return ResponseUtil.failed(GOODS_UNSHELVE, "库存不足");
        }
    ...
    public Object goodscount(@LoginUser Integer userId) {
        ...
        return ResponseUtil.success(goodsCount);
    }
