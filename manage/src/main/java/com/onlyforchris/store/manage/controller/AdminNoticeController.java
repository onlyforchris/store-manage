...
import static com.onlyforchris.store.manage.common.AdminResponseCode.NOTICE_UPDATE_NOT_ALLOWED;
...
public class AdminNoticeController {
    ...
    public Object update(@RequestBody Notice notice) {
        ...
        if(noticeAdminService.countReadByNoticeId(notice.getId()) > 0){
            return ResponseUtil.failed(NOTICE_UPDATE_NOT_ALLOWED, "通知已被阅读，不能重新编辑");
        }
        // 1. 更新通知记录
        notice.setAdminId(getAdminId());
