...
import com.onlyforchris.store.dal.mapper.CategoryMapper;
import com.onlyforchris.store.dal.model.Category;
import com.onlyforchris.store.dal.model.CategoryExample;
...
public class CategoryService {
    ...
    private final Category.Column[] CHANNEL = {Category.Column.id, Category.Column.name, Category.Column.iconUrl};
